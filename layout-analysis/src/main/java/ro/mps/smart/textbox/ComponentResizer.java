...
public class ComponentResizer extends MouseAdapter {
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ComponentResizer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) throws Exception {
